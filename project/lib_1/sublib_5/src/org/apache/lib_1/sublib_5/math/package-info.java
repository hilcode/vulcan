 ...
 * These include classes to a {@link org.apache.lib_1.sublib_5.math.Fraction} class, various utilities for random numbers, and the flagship class, {@link org.apache.lib_1.sublib_5.math.NumberUtils} which contains a handful of classic number functions.</p>
 *
 * <p>There are two aspects of this package that should be highlighted.
 * The first is {@link org.apache.lib_1.sublib_5.math.NumberUtils#createNumber(String)}, a method which does its best to convert a String into a {@link java.lang.Number} object.
 ...
 * NumberUtils also has a related {@link org.apache.lib_1.sublib_5.math.NumberUtils#isCreatable(String)} method.</p>
 *
 * @since 2.0
 */
