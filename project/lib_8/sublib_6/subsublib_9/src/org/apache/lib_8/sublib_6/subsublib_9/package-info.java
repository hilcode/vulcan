 ...
 * However {@link org.apache.lib_8.sublib_6.subsublib_9.CharSet} is not currently guaranteed thread-safe under all circumstances.
 *
 * <p>The top level package contains various Utils classes, whilst there are various subpackages including {@link org.apache.lib_8.sublib_6.subsublib_9.math}, {@link org.apache.lib_8.sublib_6.subsublib_9.concurrent} and {@link org.apache.lib_8.sublib_6.subsublib_9.builder}.
 ...
 * The first is {@link org.apache.lib_8.sublib_6.subsublib_9.StringUtils}, oodles and oodles of functions which tweak, transform, squeeze and cuddle {@link java.lang.String java.lang.Strings}.
 * In addition to StringUtils, there are a series of other String manipulating classes; {@link org.apache.lib_8.sublib_6.subsublib_9.RandomStringUtils} and {@link org.apache.lib_8.sublib_6.subsublib_9.StringEscapeUtils StringEscapeUtils}.
 ...
 * StringUtils' {@link org.apache.lib_8.sublib_6.subsublib_9.StringUtils#capitalize(String)}, {@link org.apache.lib_8.sublib_6.subsublib_9.StringUtils#substringBetween(String, String)}/{@link org.apache.lib_8.sublib_6.subsublib_9.StringUtils#substringBefore(String, String) Before}/{@link org.apache.lib_8.sublib_6.subsublib_9.StringUtils#substringAfter(String, String) After}, {@link org.apache.lib_8.sublib_6.subsublib_9.StringUtils#split(String)} and {@link org.apache.lib_8.sublib_6.subsublib_9.StringUtils#join(Object[])} are good methods to begin with.</p>
 *
 ...
 * {@link org.apache.lib_8.sublib_6.subsublib_9.CharUtils} exists for this purpose, while {@link org.apache.lib_8.sublib_6.subsublib_9.CharSetUtils} exists for set-manipulation of Strings.
 ...
 *
 * <p>{@link org.apache.lib_8.sublib_6.subsublib_9.CharRange} and {@link org.apache.lib_8.sublib_6.subsublib_9.CharSet} are both used internally by CharSetUtils, and will probably rarely be used.</p>
 *
 ...
 *
 * <p>The {@link org.apache.lib_8.sublib_6.subsublib_9.CharEncoding} class is also used to interact with the Java environment and may be used to see which character encodings are supported in a particular environment.</p>
 *
 ...
 *
 * <p>Would you believe it, {@link org.apache.lib_8.sublib_6.subsublib_9.ObjectUtils} contains handy functions for Objects, mainly null-safe implementations of the methods on {@link java.lang.Object}.</p>
 *
 * <p>{@link org.apache.lib_8.sublib_6.subsublib_9.ClassUtils} is largely a set of helper methods for reflection.
 ...
 *
 * <p>Next up, {@link org.apache.lib_8.sublib_6.subsublib_9.ArrayUtils}.
 ...
 * </ul>
 *
 * <p>Lastly, {@link org.apache.lib_8.sublib_6.subsublib_9.ArrayUtils#toMap(Object[])} is worthy of special note.
 ...
 * </pre>
 *
 * <p>Our final util class is {@link org.apache.lib_8.sublib_6.subsublib_9.BooleanUtils}.
 * It contains various Boolean acting methods, probably of most interest is the {@link org.apache.lib_8.sublib_6.subsublib_9.BooleanUtils#toBoolean(String)} method which turns various positive/negative Strings into a Boolean object, and not just true/false as with Boolean.valueOf.</p>
 *
 ...
 * <p>The {@link org.apache.lib_8.sublib_6.subsublib_9.BitField} class provides a wrapper class around the classic bitmask integer, whilst the {@link org.apache.lib_8.sublib_6.subsublib_9.Validate} class may be used for assertions (remember, we support Java 1.2).</p>
 *
 * @since 1.0
 */
