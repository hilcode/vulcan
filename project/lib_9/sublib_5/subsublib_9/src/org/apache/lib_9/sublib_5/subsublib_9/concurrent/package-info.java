 ...
 * threads. All these classes implement the {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.ConcurrentInitializer} interface
 ...
 *
 * <p>
 * A {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.ConcurrentInitializer} produces an object. By calling the
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.ConcurrentInitializer#get() get()} method the object managed by the
 * initializer can be obtained. There are different implementations of the interface available addressing various use
 * cases:
 * </p>
 *
 * <p>
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.ConstantInitializer} is a very straightforward implementation of the
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.ConcurrentInitializer} interface: An instance is passed an object when it
 ...
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.ConcurrentInitializer}.
 * </p>
 *
 * <p>
 * The {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.LazyInitializer} class can be used to defer the creation of an object
 ...
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.LazyInitializer} implements the <em>double-check idiom for an instance
 ...
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.LazyInitializer} comes into play. We create a specialized subclass for
 * creating and initializing an instance of our messaging service.
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.LazyInitializer} declares an abstract
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.LazyInitializer#initialize() initialize()} method which we have to
 ...
 *
 * <p>
 * The {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.AtomicInitializer} class is very similar to
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.LazyInitializer}. It serves the same purpose: to defer the creation of an
 * object until it is needed. The internal structure is also very similar. Again there is an abstract
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.AtomicInitializer#initialize() initialize()} method which has to be
 ...
 *
 * <p>
 * With {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.AtomicSafeInitializer} there is yet another variant implementing the
 * lazy initializing pattern. Its implementation is close to
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.AtomicInitializer}; it also uses atomic variables internally and therefore
 * does not need synchronization. The name &quot;Safe&quot; is derived from the fact that it implements an additional
 * check which guarantees that the {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.AtomicSafeInitializer#initialize()
 * initialize()} method is called only once. So it behaves exactly in the same way as
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.LazyInitializer}.
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.AtomicInitializer} is probably the most efficient implementation due to
 ...
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.AtomicInitializer} is a good choice.
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.AtomicSafeInitializer} and
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.LazyInitializer} both guarantee that the initialization method is called
 * only once. Because {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.AtomicSafeInitializer} does not use synchronization it
 * is probably slightly more efficient than {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.LazyInitializer}, but the
 * concrete numbers might depend on the level of concurrency.
 * </p>
 *
 * <p>
 * Another implementation of the {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.ConcurrentInitializer} interface is
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.BackgroundInitializer}. It is again an abstract base class with an
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.BackgroundInitializer#initialize() initialize()} method that has to be
 * defined by concrete subclasses. The idea of {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.BackgroundInitializer} is that
 ...
 * specialized implementation of {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.BackgroundInitializer} can be created for
 * this purpose:
 * </p>
 *
 * <pre>
 ...
 *
 * <p>
 * Related to {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.BackgroundInitializer} is the
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.MultiBackgroundInitializer} class. As the name implies, this class can
 * handle multiple initializations in parallel. The basic usage scenario is that a
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.MultiBackgroundInitializer} instance is created. Then an arbitrary number
 * of {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.BackgroundInitializer} objects is added using the
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.MultiBackgroundInitializer#addInitializer(String, BackgroundInitializer)}
 ...
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.MultiBackgroundInitializer#start()} method is called. This starts
 ...
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.MultiBackgroundInitializer.MultiBackgroundInitializerResults}. This object
 ...
 *
 * <p>
 * With {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.MultiBackgroundInitializer} we can extend our example to perform
 ...
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.BackgroundInitializer} implementations exist. The following example
 * fragment shows the usage of {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.MultiBackgroundInitializer} for this purpose:
 * </p>
 *
 * <pre>
 * <code>
 ...
 *
 * <p>
 * If background initializers - including {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.MultiBackgroundInitializer} - are
 ...
 * concurrency. There is the {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.ConcurrentUtils} class with a bunch of static
 ...
 *
 * <p>
 * The {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.ConcurrentUtils#extractCause(java.util.concurrent.ExecutionException)}
 ...
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.ConcurrentException} is created and initialized with the root cause
 * ({@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.ConcurrentException} is a new exception class in the
 * {@code o.a.c.l.concurrent} package). So if you get such a
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.ConcurrentException}, you can be sure that the original cause for the
 ...
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.ConcurrentUtils#extractCauseUnchecked(java.util.concurrent.ExecutionException)}
 * method which behaves like {@code extractCause()}, but returns the unchecked exception
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.ConcurrentRuntimeException} instead.
 * </p>
 *
 * <p>
 * In addition to the {@code extractCause()} methods there are corresponding
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.ConcurrentUtils#handleCause(java.util.concurrent.ExecutionException)} and
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.ConcurrentUtils#handleCauseUnchecked(java.util.concurrent.ExecutionException)}
 * methods. These methods extract the cause of the passed in {@link java.util.concurrent.ExecutionException} and throw
 * the resulting {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.ConcurrentException} or
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.ConcurrentRuntimeException}. This makes it easy to transform an
 * {@link java.util.concurrent.ExecutionException} into a
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.ConcurrentException} ignoring unchecked exceptions:
 * </p>
 *
 * <pre>
 * <code>
 ...
 * {@code initialize()} method is passed a {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.ConcurrentInitializer} object and
 * returns the object created by this initializer. It is null-safe. The {@code initializeUnchecked()} method works
 * analogously, but a {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.ConcurrentException} throws by the initializer is
 * rethrown as a {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.ConcurrentRuntimeException}. This is especially useful if
 * the specific {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.ConcurrentInitializer} does not throw checked exceptions.
 ...
 *
 * <p>
 * Using the {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.ConcurrentUtils#initializeUnchecked(ConcurrentInitializer)}
 * method, this becomes:
 * </p>
 *
 * <pre>
 ...
 *
 * <p>
 * With {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.BasicThreadFactory} Commons Lang has an implementation of
 ...
 * uncaught exceptions. Instances of {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.BasicThreadFactory} are created and
 * configured using the nested {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.BasicThreadFactory.Builder} class. The
 ...
 *
 * <p>
 * The nested {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.BasicThreadFactory.Builder} class defines some methods for
 * configuring the new {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.BasicThreadFactory} instance. Objects of this class
 ...
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.BasicThreadFactory.Builder#wrappedFactory(java.util.concurrent.ThreadFactory)
 ...
 *
 * <p>
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.TimedSemaphore} allows restricted access to a resource in a given time
 ...
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.TimedSemaphore#acquire()} method. The semaphore keeps track about the
 ...
 *
 * <p>
 * What are use cases for {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.TimedSemaphore}? One example is to artificially
 ...
 * {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.TimedSemaphore} object this can be achieved. The semaphore can be
 ...
 * has to create an instance of {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.TimedSemaphore} and to initialize its
 ...
 *
 * <p>
 * With the {@link org.apache.lib_9.sublib_5.subsublib_9.concurrent.TimedSemaphore#setLimit(int)} method the number of permits
